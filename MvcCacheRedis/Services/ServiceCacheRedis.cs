...
namespace MvcCacheRedis.Services
{
    public class ServiceCacheRedis
    {
        ...
        //TENDREMOS UN METODO PARA ALMACENAR PRODUCTOS FAVORITOS DENTRO DE CACHE REDIS

        public void AddProductoFavorito(Producto producto)
        {
            //CACHE REDIS FUNCIONA CON CLAVES UNICAS QUE DEBERIAN SER POR USUARIO
            //NOSOTROS NO TENEMOS LOGIN, TODAS LES PERSONAS VERAN LOS  MISMOS FAVORITOS.
            //LO SUYO SERÍA CONCATENAR LA CLAVE CON EL ID DEL USUARIO
            //ALMACENAREMOS UNA COLECCION DE PRODUCTOS.
            //LO PRIMERO SERÁ VISUALIZAR SI TENEMOS PRODUCTOS ALMACENADOS
            string jsonproductos = this.database.StringGet("favoritos");
            List<Producto> favoritos;
            if (jsonproductos == null)
            {
                //TODAVIA NO HEMOS ALMACENADO PRODUCTO
            ...
            //CONVERTIMOS FAVORITOS A FORMATO JSON
        ...
        //METODO PAR ARECUPERAR LOS PRODUCTOS FAVORITOS
